...
class MailSender
{
     ...
     * SMTP配置
     * */
    private $smtp_host = 'smtp.163.com';//SMTP服务器地址
    private $smtp_from = 'Rakkaus-管理员';//发送者
    private $smtp_username = 'rakkauss@163.com';//邮箱账号
    private $smtp_password = 'EJLDTPIYWEGSWRLX';//邮箱密码
